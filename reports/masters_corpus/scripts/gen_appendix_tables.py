...
"one table per metric family. st1 covers all 26 books; nd1 covers the 21 scored (the 5 "
"giants are omitted from nd1 tables until their runs finish). See Sections 2 and 5-9 for "
...
OUT='/tmp/claude-1000/-home-edward-Projects-StoryDaemon/c864fea6-ffe4-4b24-8beb-cc1e1a96599a/scratchpad/appendix_tables.md'
open(OUT,'w').write('\n'.join(P)+'\n')
print('wrote', OUT)
